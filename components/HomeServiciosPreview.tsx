...
export default function HomeServiciosPreview() {
  return (
    <section className="w-full max-w-[1200px] mx-auto py-16 px-8 flex flex-col gap-10">
      <h3 className="text-2xl md:text-3xl font-black uppercase tracking-tight text-center text-white mb-4">
        SERVICIOS <span className="text-[#3B82F6]">DESTACADOS</span>
      </h3>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="group bg-[#0e1419] border border-[#1f262e] rounded-sm shadow-xl p-8 flex flex-col items-center text-center transition-all hover:border-[#3b82f6]/30 cursor-pointer relative overflow-hidden">
