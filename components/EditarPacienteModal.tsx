          ...
          >
            <div className="sticky top-0 bg-cardDark/95 backdrop-blur-3xl border-b border-white/5 px-8 py-6 flex items-center justify-between z-10">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center shadow-xl">
                  <UserCog className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h2 className="text-2xl font-black uppercase italic text-white tracking-tighter">Editar Paciente</h2>
                  <p className="text-[10px] uppercase tracking-[0.3em] font-bold text-slate-500">Actualizar información base</p>
                </div>
              </div>
              <button 
                onClick={onClose}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <select {...register('status')} className={inputStyles}>
                    <option value="Activo" className="bg-darkNavy text-emerald-400">Activo</option>
                    <option value="En Pausa" className="bg-darkNavy text-amber-400">En Pausa</option>
                    <option value="Alta" className="bg-darkNavy text-blue-400">Alta Clínica</option>
                  </select>
                </div>

                <div className="md:col-span-2 pt-6 border-t border-white/5">
                  <h3 className="text-[10px] uppercase font-black text-white/50 tracking-widest mb-6">Contacto y Medidas (Opcional)</h3>
                </div>
              ...
              <div className="pt-8 border-t border-white/5 flex gap-4 justify-end">
                ...
                <button 
                  ...
                  className="px-8 py-3 rounded-xl font-black uppercase text-xs tracking-widest bg-white text-navy hover:scale-105 transition-all shadow-lg disabled:opacity-50 flex items-center gap-2"
                >
