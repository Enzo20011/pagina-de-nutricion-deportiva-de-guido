...
export default function WhatsAppButton({
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-8 right-8 z-[60] flex items-center justify-center group outline-none"
    ...
    >
      ...
      <div className="relative z-10 w-16 h-16 flex items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_40px_rgba(37,211,102,0.4)] group-hover:shadow-[0_20px_60px_rgba(37,211,102,0.6)] transition-all duration-500 border-2 border-white/5">
        <svg 
          viewBox="0 0 24 24" 
          className="w-10 h-10 fill-current drop-shadow-md"
